...
public class ReadDefectDetailsForDefectId {

	public static String CheckDefectExists(int DefectID, int currentPage) {
		...
		try{
			...
			List<ReadDefectIdWithSummary> defectDetailsList = db.findByIndex("\"selector\": {\"_id\": {\"$gt\": 0},\"DefectID\": {\"$eq\":\""+DefectID+"\"}},\"skip\":"+skipValue+",\"limit\":"+limitValue+"", ReadDefectIdWithSummary.class);  
	...
	public static String CheckDefectExists(int DefectID, String Summary) {
	...
	public static String CheckDefectExists(int DefectID) {
